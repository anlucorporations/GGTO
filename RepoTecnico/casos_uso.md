...
9. **Decisiones derivadas registradas.** Los umbrales de desempeño se citan como **D-24** (1.000 casos; filtrado y orden &lt; 1,5 s; MONITOREO &lt; 3 s). Rango de decisiones vigente para este documento: **D-01 a D-56**. Las decisiones **D-42 a D-50** se aplicaron en la revisión del 15/09/2026, las **D-51 a D-54** en la segunda pasada (H-N-27) y la **D-56** (historial inmutable `historial.jsonl`, H-10 cerrado, RNF-09 completo) en esta actualización.
