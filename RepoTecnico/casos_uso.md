...
- **Fuentes normativas (leídas completas, no modificadas):**
  ...
  `RepoTecnico/requerimientos.md` (29 RF, **16 RNF**, 11 RT, 8 RN, decisiones **D-01 a D-78**, ambigüedades A-01 a A-18 **todas cerradas**),
...
1. El operador abre la pestaña **PANEL**, que aloja el bloque **INGESTA** (no es una pestaña propia: las pestañas son 7; **D-70**), pulsa *Cargar CSV diario* y elige el archivo `detalle_averias_gpon DD_MM_AAAA.csv`.
